...
declare const args: {
    ...
    readonly force: {
        readonly describe: "Don't prompt for confirmation before deleting a branch or resetting trunk to remote.";
        readonly demandOption: false;
        readonly default: false;
        readonly type: "boolean";
        readonly alias: "f";
...
export declare const description = "Pull the trunk branch from remote and delete any branches that have been merged. If trunk cannot be fast-forwarded to match remote, overwrites trunk with the remote version.";
