...
async function getDownstackDependencies(args, params, context) {
    const response = await retyped_routes_1.request.requestWithArgs(context.userConfig.getApiServerUrl(), graphite_cli_routes_1.API_ROUTES.downstackDependencies, {}, {
