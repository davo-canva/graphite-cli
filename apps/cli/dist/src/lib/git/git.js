...
const commit_info_1 = require("./commit_info");
...
const files_changed_1 = require("./files_changed");
const file_contents_1 = require("./file_contents");
...
const restore_file_1 = require("./restore_file");
...
function composeGitInternal() {
    return {
        ...(0, get_sha_1.composeGetRemoteSha)(),
        addAll: add_all_1.addAll,
        getCommitAuthor: commit_info_1.getCommitAuthor,
        getCommitDate: commit_info_1.getCommitDate,
        getFilesChanged: files_changed_1.getFilesChanged,
        getStatus: status_1.getStatus,
        ...
        getFileContents: file_contents_1.getFileContents,
        ...
        mixedReset: reset_branch_1.mixedReset,
        hardReset: reset_branch_1.hardReset,
        ...
        clean: clean_1.clean,
        restoreFile: restore_file_1.restoreFile,
    };
}
