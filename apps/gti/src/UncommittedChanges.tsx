      ...
      <Tooltip
        title={
          comparison.type === ComparisonType.UncommittedChanges
            ...
            : "Revert changes made by this commit"
        }
        key="revert"
        delayMs={1000}
      >
        <VSCodeButton
          ...
          onClick={() => {
            void platform
              .confirm(
                comparison.type === ComparisonType.UncommittedChanges
                  ? `Are you sure you want to revert ${file.path}?`
                  : `Are you sure you want to revert ${file.path} back to how it was just before the last commit? Uncommitted changes to this file will be lost.`
              )
              .then((ok) => {
                if (!ok) {
                  return;
